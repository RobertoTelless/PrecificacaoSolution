        ...
        public Int32 ValidateCreate(UNIDADE item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<UNIDADE>(item)
                };
        ...
        public Int32 ValidateEdit(UNIDADE item, UNIDADE itemAntes, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<UNIDADE>(item),
                    LOG_TX_TEXTO_ANTES = Serialization.SerializeJSON<UNIDADE>(itemAntes)
                };
        ...
        public Int32 ValidateDelete(UNIDADE item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_TEXTO = "Unidade: " + item.UNID_NM_NOME
                };
