        ...
        public Int32 ValidateCreate(CRM_ORIGEM item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<CRM_ORIGEM>(item)
                };
        ...
        public Int32 ValidateEdit(CRM_ORIGEM item, CRM_ORIGEM itemAntes, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<CRM_ORIGEM>(item),
                    LOG_TX_TEXTO_ANTES = Serialization.SerializeJSON<CRM_ORIGEM>(itemAntes)
                };
        ...
        public Int32 ValidateDelete(CRM_ORIGEM item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_TEXTO = item.CROR_NM_NOME
                };
