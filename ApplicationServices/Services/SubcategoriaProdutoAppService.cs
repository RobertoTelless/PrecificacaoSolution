        ...
        public Int32 ValidateCreate(SUBCATEGORIA_PRODUTO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<SUBCATEGORIA_PRODUTO>(item)
                };
        ...
        public Int32 ValidateEdit(SUBCATEGORIA_PRODUTO item, SUBCATEGORIA_PRODUTO itemAntes, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<SUBCATEGORIA_PRODUTO>(item),
                    LOG_TX_TEXTO_ANTES = Serialization.SerializeJSON<SUBCATEGORIA_PRODUTO>(itemAntes)
                };
        ...
        public Int32 ValidateDelete(SUBCATEGORIA_PRODUTO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_TEXTO = "Subcategoria: " + item.SCPR_NM_NOME
                };
