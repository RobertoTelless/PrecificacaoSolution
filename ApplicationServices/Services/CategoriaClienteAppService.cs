        ...
        public Int32 ValidateCreate(CATEGORIA_CLIENTE item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<CATEGORIA_CLIENTE>(item)
                };
        ...
        public Int32 ValidateEdit(CATEGORIA_CLIENTE item, CATEGORIA_CLIENTE itemAntes, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<CATEGORIA_CLIENTE>(item),
                    LOG_TX_TEXTO_ANTES = Serialization.SerializeJSON<CATEGORIA_CLIENTE>(itemAntes)
                };
        ...
        public Int32 ValidateDelete(CATEGORIA_CLIENTE item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_TEXTO = item.CACL_NM_NOME
                };
