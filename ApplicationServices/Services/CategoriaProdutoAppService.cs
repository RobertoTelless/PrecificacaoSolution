        ...
        public Int32 ValidateCreate(CATEGORIA_PRODUTO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<CATEGORIA_PRODUTO>(item)
                };
        ...
        public Int32 ValidateEdit(CATEGORIA_PRODUTO item, CATEGORIA_PRODUTO itemAntes, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<CATEGORIA_PRODUTO>(item),
                    LOG_TX_TEXTO_ANTES = Serialization.SerializeJSON<CATEGORIA_PRODUTO>(itemAntes)
                };
        ...
        public Int32 ValidateDelete(CATEGORIA_PRODUTO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_TEXTO = "Categoria: " + item.CAPR_NM_NOME
                };
