        ...
        public Int32 ValidateCreate(MOTIVO_CANCELAMENTO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<MOTIVO_CANCELAMENTO>(item)
                };
        ...
        public Int32 ValidateEdit(MOTIVO_CANCELAMENTO item, MOTIVO_CANCELAMENTO itemAntes, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_IN_ATIVO = 1,
                    LOG_TX_TEXTO = Serialization.SerializeJSON<MOTIVO_CANCELAMENTO>(item),
                    LOG_TX_TEXTO_ANTES = Serialization.SerializeJSON<MOTIVO_CANCELAMENTO>(itemAntes)
                };
        ...
        public Int32 ValidateDelete(MOTIVO_CANCELAMENTO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_TEXTO = item.MOCA_NM_NOME
                };
