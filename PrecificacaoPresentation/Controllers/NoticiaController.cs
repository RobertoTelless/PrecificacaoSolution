...
namespace ERP_Condominios_Solution.Controllers
{
    public class NoticiaController : Controller
    {
        ...
        public ActionResult VerNoticia(Int32 id)
        {
            ...
            item.NOTC_NR_ACESSOS = ++item.NOTC_NR_ACESSOS;
            objetoAntes = item;
        ...
        public ActionResult FiltrarNoticia(NOTICIA item)
        {
            ...
            try
            {
                ...
                Int32 volta = baseApp.ExecuteFilter(item.NOTC_NM_TITULO, item.NOTC_NM_AUTOR, item.NOTC_DT_DATA_AUTOR, item.NOTC_TX_NOTICIA, item.NOTC_LK_LINK, idAss, out listaObj);
