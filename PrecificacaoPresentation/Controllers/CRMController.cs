...
namespace ERP_Condominios_Solution.Controllers
{
    public class CRMController : Controller
    {
        ...
        public ActionResult AcompanhamentoProcessoCRM(Int32 id)
        {
            ...
            CRM_PROPOSTA prop = props.Where(p => p.CRPR_IN_STATUS == 2 || p.CRPR_IN_STATUS == 1 || p.CRPR_IN_STATUS == 5).FirstOrDefault();
        ...
        public ActionResult GerarRelatorioPedido()
        {
            ...
            String data = DateTime.Today.Date.ToShortDateString();
            data = data.Substring(0, 2) + data.Substring(3, 2) + data.Substring(6, 4);
            String nomeRel = "CRM_Pedido_" + aten.CRPV_IN_NUMERO_GERADO.ToString() + "_" + data + ".pdf";
            CLIENTE cliente = cliApp.GetItemById(crm.CLIE_CD_ID);
            Session["VoltaCRM"] = 0;
            ...
            Font meuFontOrange = FontFactory.GetFont("Arial", 12, iTextSharp.text.Font.BOLD, BaseColor.ORANGE);
            Font meuFontTitulo = FontFactory.GetFont("Arial", 12, iTextSharp.text.Font.BOLD, BaseColor.BLACK);
            Font meuFontGreen = FontFactory.GetFont("Arial", 12, iTextSharp.text.Font.BOLD, BaseColor.DARK_GRAY);

            // Preparar campos de texto HTML
            String intro = HtmlToPlainText(aten.CRPV_TX_INTRODUCAO);
            String corpo = HtmlToPlainText(aten.CRPV_TX_OUTROS_ITENS);
            ...
            String corpo1 = CrossCutting.HtmlToText.ConvertHtml(aten.CRPV_TX_OUTROS_ITENS);
            ...
            cell = new PdfPCell(new Paragraph("Pedido de Venda - Especificações", meuFontTitulo))
            {
                VerticalAlignment = Element.ALIGN_MIDDLE,
                HorizontalAlignment = Element.ALIGN_CENTER
            };
            ...
            cell = new PdfPCell(new Paragraph("Dados do Pedido", meuFontGreen));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("Prazo (Dias): " + aten.CRPV_IN_PRAZO_ENTREGA, meuFont1));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            Chunk chunk2 = new Chunk("Outros Serviços", FontFactory.GetFont("Arial", 8, Font.BOLD, BaseColor.BLACK));
            pdfDoc.Add(chunk2);
            line1 = new Paragraph(new Chunk(new iTextSharp.text.pdf.draw.LineSeparator(0.0F, 100.0F, BaseColor.WHITE, Element.ALIGN_LEFT, 1)));
            pdfDoc.Add(line1);
            Chunk chunk21 = new Chunk(corpo1, FontFactory.GetFont("Arial", 8, Font.NORMAL, BaseColor.BLACK));
            ...
            cell = new PdfPCell(new Paragraph("Valor Produtos (R$): " + CrossCutting.Formatters.DecimalFormatter(aten.CRPV_VL_TOTAL_ITENS.Value), meuFontBold));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("Valor Serviços (R$): " + CrossCutting.Formatters.DecimalFormatter(aten.CRPV_VL_TOTAL_SERVICOS.Value), meuFontBold));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("ICMS (R$): " + CrossCutting.Formatters.DecimalFormatter(aten.CRPV_VL_ICMS.Value), meuFontBold));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("IPI (R$): " + CrossCutting.Formatters.DecimalFormatter(aten.CRPV_VL_IPI.Value), meuFontBold));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("Total (R$): " + CrossCutting.Formatters.DecimalFormatter(aten.CRPV_VL_VALOR.Value), meuFontAzul));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            cell = new PdfPCell(new Paragraph("Dados de Entrega", meuFontGreen));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("Peso Bruto (Kg): " + aten.CRPV_VL_PESO_BRUTO.Value.ToString(), meuFontBold));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            table.AddCell(cell);
            cell = new PdfPCell(new Paragraph("Peso Líquido (Kg): " + aten.CRPV_VL_PESO_LIQUIDO.Value.ToString(), meuFontBold));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            cell = new PdfPCell(new Paragraph("Itens do Pedido", meuFontGreen));
            cell.Border = 0;
            cell.Colspan = 4;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            // Itens do Pedido
            if (aten.CRM_PEDIDO_VENDA_ITEM.Count > 0)
            {
                table = new PdfPTable(new float[] { 80f, 120f, 100f, 60f, 80f, 80f, 80f,80f });
                table.WidthPercentage = 100;
                table.HorizontalAlignment = 0;
                table.SpacingBefore = 1f;
                table.SpacingAfter = 1f;
                ...
                cell.BackgroundColor = BaseColor.LIGHT_GRAY;
                table.AddCell(cell);
                cell = new PdfPCell(new Paragraph("Unitário (R$)", meuFont))
                {
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    HorizontalAlignment = Element.ALIGN_LEFT
                };
                cell.BackgroundColor = BaseColor.LIGHT_GRAY;
                table.AddCell(cell);
                cell = new PdfPCell(new Paragraph("Desconto (R$)", meuFont))
                {
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    HorizontalAlignment = Element.ALIGN_LEFT
                };
                ...
                foreach (CRM_PEDIDO_VENDA_ITEM item in aten.CRM_PEDIDO_VENDA_ITEM)
                {
                    ...
                    {
                        cell = new PdfPCell(new Paragraph("Serviço", meuFont))
                        {
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                            HorizontalAlignment = Element.ALIGN_LEFT
                        };
                        table.AddCell(cell);
                        cell = new PdfPCell(new Paragraph(item.SERVICO.SERV_NM_NOME, meuFont))
                        {
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                            HorizontalAlignment = Element.ALIGN_LEFT
                        };
                    ...
                    table.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(item.CRPI_IN_QUANTIDADE.ToString(), meuFont))
                    {
                        VerticalAlignment = Element.ALIGN_MIDDLE,
                        HorizontalAlignment = Element.ALIGN_LEFT
                    };
                    table.AddCell(cell);
                    if (item.CRPI_VL_PRECO_AJUSTADO != null)
                    {
                        cell = new PdfPCell(new Paragraph(CrossCutting.Formatters.DecimalFormatter(item.CRPI_VL_PRECO_AJUSTADO.Value), meuFont))
                        {
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                            HorizontalAlignment = Element.ALIGN_LEFT
                        };
                    ...
                    if (item.CRPI_VL_DESCONTO != null)
                    {
                        cell = new PdfPCell(new Paragraph(CrossCutting.Formatters.DecimalFormatter(item.CRPI_VL_DESCONTO.Value), meuFont))
                        {
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                            HorizontalAlignment = Element.ALIGN_LEFT
                        };
                    ...
                    if (item.CRPI_VL_PRECO_TOTAL != null)
                    {
                        cell = new PdfPCell(new Paragraph(CrossCutting.Formatters.DecimalFormatter(item.CRPI_VL_PRECO_TOTAL.Value), meuFont))
                        {
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                            HorizontalAlignment = Element.ALIGN_LEFT
                        };
        ...
        public Int32 ProcessarEnvioPedidoEMail(MensagemViewModel vm, CRM_PEDIDO_VENDA item, USUARIO usuario)
        {
            ...
            foreach (var ipc in peds.Where(x => x.CRPI_IN_ATIVO == 1).ToList())
            {
                ...
                + "<td style=\"width:60%\">" + (ipc.CRPI_IN_TIPO_ITEM == 1 ? ipc.PRODUTO.PROD_NM_NOME : ipc.SERVICO.SERV_NM_NOME) + "</td>"
        ...
        public JsonResult GetCustoProduto(Int32 id, Int32? fili)
        {
            ...
            if (fil != null)
            {
                ...
                if (prod != null)
                {
                    String p = prod.PRTP_VL_PRECO.ToString();
                    p = p.Replace(".", ",");
                    Decimal? pp = Convert.ToDecimal(p);

                    result.Add("custo", pp == null ? 0 : pp);
                    result.Add("unidade", prod.PRODUTO.UNIDADE.UNID_NM_NOME);
                    Session["PrecoOriginal"] = prod.PRTP_VL_PRECO;
                }
                else
                {
                    var prod1 = proApp.GetById(id);
                    result.Add("custo", prod1.PROD_VL_PRECO_VENDA == null ? 0 : prod1.PROD_VL_PRECO_VENDA);
                    result.Add("unidade", prod1.UNIDADE == null ? "" : prod1.UNIDADE.UNID_NM_NOME);
                    Session["PrecoOriginal"] = prod1.PRTP_VL_PRECO;
                }
            }
            else
            {
            ...
            if (fil != null)
            {
                ...
                if (prod.SERVICO_TABELA_PRECO.Count > 0)
                {
                    ...
                    if (serv.Count > 0)
                    {
                        ...
                        Session["PrecoOriginal"] = serv1.SETP_VL_PRECO;
                    }
                    else
                    {
                        ...
                        result.Add("unidade", prod.UNIDADE == null ? "" : prod.UNIDADE.UNID_NM_NOME);
                        Session["PrecoOriginal"] = prod.SERV_VL_PRECO;
                    }
                }
                else
                {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (vm.CRPI_IN_TIPO_ITEM == 1)
                    {
                        ...
                        if (conf.CONF_IN_INCLUIR_SEM_ESTOQUE == 0)
                        {
        ...
        public ActionResult FiltrarVenda(CRM_PEDIDO_VENDA item)
        {
            ...
            try
            {
                ...
                Int32 volta = baseApp.ExecuteFilterVenda(item.CRPV_DS_CANCELAMENTO, item.CRPV_IN_STATUS, item.CRPV_DT_PEDIDO, item.CRPV_DT_CANCELAMENTO, item.FILI_CD_ID, item.USUA_CD_ID, idAss, out listaObj);
