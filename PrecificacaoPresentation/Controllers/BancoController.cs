    ...
    public class BancoController : Controller
    {
        ...
        public ActionResult MontarTelaBanco()
        {
            ...
            if (Session["MensBanco"] != null)
            {
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0165", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensBanco"] == 4)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0166", CultureInfo.CurrentCulture));
                }
            }
        ...
        public ActionResult EditarBanco(Int32 id)
        {
            ...
            if (Session["MensBanco"] != null)
            {
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0167", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensBanco"] == 2)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0011", CultureInfo.CurrentCulture));
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0168", CultureInfo.CurrentCulture));
                }
            }
        ...
        public ActionResult EditarConta(Int32 id)
        {
            ...
            if (Session["FiltroLancamento"] != null)
            {
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0169", CultureInfo.CurrentCulture));
                }
            }
        ...
        public ActionResult ExcluirConta(Int32 id)
        {
            ...
            {
                Session["MensBanco"] = 4;
                return RedirectToAction("VoltarAnexoBanco");
            }
            listaMasterConta = new List<CONTA_BANCO>();
            Session["ListaContaBancaria"] = null;
            return RedirectToAction("VoltarAnexoBanco");
        ...
        public ActionResult ExcluirLancamento(Int32 id)
        {
            ...
            {
                item.CONTA_BANCO.COBA_VL_SALDO_ATUAL = item.CONTA_BANCO.COBA_VL_SALDO_ATUAL - item.CBLA_VL_VALOR;
            }
            else
            {
                item.CONTA_BANCO.COBA_VL_SALDO_ATUAL = item.CONTA_BANCO.COBA_VL_SALDO_ATUAL + item.CBLA_VL_VALOR;
        ...
        public Int32 AcertaSaldo(CONTA_BANCO_LANCAMENTO item)
        {
            try
            {
                ...
                if (item.CBLA_IN_TIPO == 1)
                {
                    lanc.CONTA_BANCO.COBA_VL_SALDO_ATUAL = lanc.CONTA_BANCO.COBA_VL_SALDO_ATUAL + item.CBLA_VL_VALOR;
                }
                else
                {
                    lanc.CONTA_BANCO.COBA_VL_SALDO_ATUAL = lanc.CONTA_BANCO.COBA_VL_SALDO_ATUAL - item.CBLA_VL_VALOR;
