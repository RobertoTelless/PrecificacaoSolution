...
namespace ERP_Condominios_Solution.Controllers
{
    public class ContaReceberController : Controller
    {
        ...
        public ContaReceberController(IContaReceberAppService crApps, ILogAppService logApps, IClienteAppService cliApps, IContaPagarAppService cpApps, IFornecedorAppService forApps, ICentroCustoAppService ccApps, IContaBancariaAppService cbApps, IFormaPagRecAppService fpApps, IPeriodicidadeAppService perApps, IContaReceberParcelaAppService pcApps, IContaPagarParcelaAppService ppApps, IContaReceberRateioAppService ratApps)
        {
            logApp = logApps;
            crApp = crApps;
            cliApp = cliApps;
        ...
        public ActionResult MontarTelaCR()
        {
            ...
            ViewBag.Contas = new SelectList(cbApp.GetAllItens(idAss).OrderBy(p => p.COBA_NM_NOME_EXIBE), "COBA_CD_ID", "COBA_NM_NOME_EXIBE");
            Session["ContasBancarias"] = cbApp.GetAllItens(idAss);
            Session["VoltaCR"] = 0;

            if ((Int32)Session["ErroSoma"] == 2)
            {
                ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0193", CultureInfo.CurrentCulture));
            }
            ...
            else if ((Int32)Session["MensVencimentoCR"] == 1)
            {
                ...
                ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0210", CultureInfo.CurrentCulture));
            }
            ...
            if (Session["MensCR"] != null)
            {
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0211", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 5)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0212", CultureInfo.CurrentCulture));
                }
            }
        ...
        public ActionResult FiltrarCR(CONTA_RECEBER item, DateTime? CARE_DT_VENCIMENTO_FINAL)
        {
            ...
            try
            {
                ...
                Int32 volta = crApp.ExecuteFilter(item.CLIE_CD_ID, item.CECU_CD_ID, item.CARE_DT_LANCAMENTO, item.CARE_DT_VENCIMENTO, CARE_DT_VENCIMENTO_FINAL, item.CARE_DS_DESCRICAO, item.CARE_IN_ABERTOS, item.FORMA_PAGTO_RECTO.COBA_CD_ID, idAss, out listaObj);
        ...
        public ActionResult VerRecebimentosMes()
        {
            ...
            ViewBag.CC = new SelectList(ccApp.GetAllItens(idAss).Where(x => x.CECU_IN_TIPO == 1).OrderBy(x => x.CECU_NM_NOME).ToList<PLANO_CONTA>(), "CECU_CD_ID", "CECU_NM_NOME");

            if (Session["MensRecebimentoMes"] != null && (Int32)Session["MensRecebimentoMes"] == 1)
            {
                ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0213", CultureInfo.CurrentCulture));
            }
            return View();
        }
        ...
        public ActionResult UploadFileQueueLancamentoCR(FileQueue file)
        {
            ...
            String caminho = "/Imagens/1/ContaReceber/" + item.CARE_CD_ID.ToString() + "/Anexos/";
        ...
        public ActionResult UploadFileLancamentoCR(HttpPostedFileBase file)
        {
            ...
            String caminho = "/Imagens/1/ContaReceber/" + itemAnx.CARE_CD_ID.ToString() + "/Anexos/";
            String path = Path.Combine(Server.MapPath(caminho), fileName);
            System.IO.Directory.CreateDirectory(Server.MapPath(caminho));
            file.SaveAs(path);
        ...
        public ActionResult IncluirCR()
        {
            ...
            ViewBag.CC = new SelectList(ccApp.GetAllItens(idAss).Where(x => x.CECU_IN_TIPO == 1).OrderBy(x => x.CECU_NM_NOME).ToList<PLANO_CONTA>(), "CECU_CD_ID", "CECU_NM_NOME");
            ViewBag.Contas = new SelectList(cbApp.GetAllItens(idAss).OrderBy(p => p.COBA_NM_NOME_EXIBE), "COBA_CD_ID", "COBA_NM_NOME_EXIBE_OLD");
        ...
        public ActionResult EditarCR(Int32 id)
        {
            ...
            {
                ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0214", CultureInfo.CurrentCulture));
                Session["IdVoltaTab"] = 1;
            }
            ...
            if (Session["MensCr"] != null)
            {
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0215", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 11)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0216", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 12)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0217", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 13)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0218", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 14)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0219", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 15)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0220", CultureInfo.CurrentCulture));
                }
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0221", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 19)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0222", CultureInfo.CurrentCulture));
                }
            }
            Session["ErroSoma"] = 0;
            Session["IdVoltaTab"] = 1;
        ...
        public ActionResult ParcelarCR(ContaReceberViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    PERIODICIDADE_TAREFA period = perApp.GetItemById(item.PETA_CD_ID.Value);
        ...
        public ActionResult DuplicarCR()
        {
            ...
            // Cria pastas
            String caminho = "/Imagens/1/ContaReceber/" + novo.CARE_CD_ID.ToString() + "/Anexos/";
            Directory.CreateDirectory(Server.MapPath(caminho));
        ...
        public ActionResult LiquidarParcelaCR(Int32 id)
        {
            ...
            if (Session["MensCr"] != null)
            {
                ...
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0223", CultureInfo.CurrentCulture));
                }
                if ((Int32)Session["MensCR"] == 21)
                {
                    ModelState.AddModelError("", PlatMensagens_Resources.ResourceManager.GetString("M0224", CultureInfo.CurrentCulture));
                }
            }
        ...
        public ActionResult LiquidarCR(Int32 id)
        {
            ...
            ViewBag.Formas = new SelectList(fpApp.GetAllItens(idAss).Where(p => p.FOPA_IN_TIPO_FORMA == 2 || p.FOPA_IN_TIPO_FORMA == 3).OrderBy(x => x.FOPR_NM_NOME_FORMA), "FOPR_CD_ID", "FOPR_NM_NOME_FORMA");
            ViewBag.Periodicidade = new SelectList(perApp.GetAllItens(), "PERI_CD_ID", "PERI_NM_NOME");
            List<SelectListItem> tipoRec = new List<SelectListItem>();
            tipoRec.Add(new SelectListItem() { Text = "Recebimento Recorrente", Value = "1" });
            tipoRec.Add(new SelectListItem() { Text = "Parcelamento", Value = "2" });
